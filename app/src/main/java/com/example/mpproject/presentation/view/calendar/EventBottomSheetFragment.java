...
public class EventBottomSheetFragment extends BottomSheetDialogFragment {
    ...
    private void prefillForm(CalendarEvent e) {
        ...
        switch (e.getType() != null ? e.getType() : "") {
            case "EXAM":           binding.chipTypeExam.setChecked(true);       break;
            case "ASSIGNMENT_DUE": binding.chipTypeAssignment.setChecked(true); break;
            case "PERSONAL":       binding.chipTypePersonal.setChecked(true);   break;
            default:               binding.chipTypeLecture.setChecked(true);    break;
        }
    ...
    private void saveEvent() {
        ...
        if (editing != null) {
            ...
            viewModel.addEvent(title, type, startMs, endMs, allDay, moduleId, description,
                    recurrencePattern, recurrenceEndMs);
